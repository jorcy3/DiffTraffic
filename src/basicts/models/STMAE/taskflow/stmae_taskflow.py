...
class STMAEForecastingTaskFlow(BasicTSForecastingTaskFlow):
    """
    STAEformer-compatible forecasting taskflow with extra enhancement targets.
    """
    ...
    def preprocess(self, runner: "BasicTSRunner", data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        data["enhancement_targets"] = data["inputs"].clone()
